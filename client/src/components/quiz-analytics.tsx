  ...
  return (
    <div>
      <div className="flex justify-between text-xs mb-1">
        <span className="text-gray-800 dark:text-gray-200">{t('question_number', { number: questionNumber })}</span>
        <span className="text-gray-600 dark:text-gray-400">{t('correct_percentage', { percent: correctPercentage })}</span>
      </div>
      ...
      <CardContent className="p-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            {t('quiz_completed_by', { count: participantCount })}
          </p>
        </div>
