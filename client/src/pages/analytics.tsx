        ...
        <TabsContent value="overview">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 mb-8">
            <Card className="bg-white dark:bg-[#1e1e1e] shadow rounded-lg">
              <CardContent className="p-6">
                <div className="flex items-center mb-2">
                  <Users className="w-5 h-5 mr-6 text-indigo-500" />
            ...
            <Card className="bg-white dark:bg-[#1e1e1e] shadow rounded-lg">
              <CardContent className="p-6">
                <div className="flex items-center mb-2">
                  <Trophy className="w-5 h-5 mr-6 text-yellow-500" />
            ...
            <Card className="bg-white dark:bg-[#1e1e1e] shadow rounded-lg">
              <CardContent className="p-6">
                <div className="flex items-center mb-2">
                  <Clock className="w-5 h-5 mr-6 text-blue-500" />
            ...
            <>
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-4 mb-8">
                <Card className="bg-white dark:bg-[#1e1e1e] shadow rounded-lg">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-2">
                      <Target className="w-5 h-5 mr-6 text-indigo-500" />
                ...
                <Card className="bg-white dark:bg-[#1e1e1e] shadow rounded-lg">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-2">
                      <Medal className="w-5 h-5 mr-6 text-blue-500" />
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex items-center">
                      {quizAnalytics.performanceTrends.trend === 'improving' ? (
                        <ArrowUp className="w-4 h-4 text-green-500 mr-6" />
                      ) : quizAnalytics.performanceTrends.trend === 'declining' ? (
                        <ArrowDown className="w-4 h-4 text-red-500 mr-6" />
                      ) : (
                        <span className="w-4 h-4 mr-6">–</span>
                      )}
                          ...
                          <div className="ml-4 mt-2 space-y-2">
                            {question.optionAnalytics.map((option, optIdx) => (
                              <div key={optIdx} className="flex items-center">
                                <div className={`w-1 h-4 mr-6 ${option.isCorrect ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
